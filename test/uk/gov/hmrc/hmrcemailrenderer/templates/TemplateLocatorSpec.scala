  ...
  "The template locator" should {
    ...
    "enumerate all template identifiers" in {
      TemplateLocator.all.map(_.templateId) should contain.only(
        ...
        "agent_registration_application_non_fixable_failure",
        ...
        "cash_declaration_GB_Currency_cy",
        ...
        "crs_fatca_file_upload_unsuccessful",
        ...
        "dtr_subcontractor_verification",
        ...
        "emac_helpdesk_bulk_deenrolment_file_auto_deleted",
        ...
        "newMessageAlert_NIRef4",
        "newMessageAlert_NIRef4_cy",
        ...
        "open_banking_payment_successful_class3Ni_multiple",
        "open_banking_payment_successful_class3Ni_multiple_cy",
        "open_banking_payment_successful_class3Ni_single",
        "open_banking_payment_successful_class3Ni_single_cy",
